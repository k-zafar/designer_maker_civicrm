...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:root@localhost/drupal_civicrm?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://root:root@localhost/civicrm?new_link=true');
}
...
$civicrm_root = '/Applications/MAMP/htdocs/drupal-civicrm/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/Applications/MAMP/htdocs/drupal-civicrm/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost:8888/drupal-civicrm/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '4a062190f268b1f25d6b3a67ba666a60');
}
...
// define( 'CIVICRM_MAIL_LOG', '/Applications/MAMP/htdocs/drupal-civicrm/sites/default/files/civicrm/templates_c//mail.log');
// }
